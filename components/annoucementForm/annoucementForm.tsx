...
export function AnnouncementForm({
  ...
  return (
    <form
      ...
      className="space-y-3  p-4 sm:p-6 md:space-y-3 mt-8 lg:mt-2"
    >
      <div>
        <Label className="block text-xs sm:text-sm md:text-[15px] font-medium">
          Título
        </Label>
        <Input
          type="text"
        ...
        >
          ...
          {!formData.image ? (
            <div className="flex flex-col items-center justify-center text-gray-500">
              <Image src="/subir.png" alt="Image Icon" width={50} height={50} />
              <p className="sm:text-[15px] text-[10px] md:text-[15px]">
      ...
      <div>
        <Label className="block text-xs sm:text-sm md:text-base md:text-[15px] font-medium">
          Descripción
        </Label>
        <Textarea
          name="description"
      ...
      <Button
        type="submit"
        className="w-full bg-[#E1BC00] text-white hover:bg-[#9b8a38] font-bold text-xs sm:text-sm md:text-base"
      >
        Publicar
      </Button>
    </form>
