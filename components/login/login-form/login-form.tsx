    ...
    <div className="flex justify-center items-center h-screen p-4 sm:p-6 md:p-0">
      <div className="bg-white p-8 rounded-2xl shadow-xl w-full sm:w-[500px] md:w-[700px] h-auto text-center">
        <div className="space-y-6">
          <h1
            className={`${ysabeau.className} text-3xl sm:text-4xl font-bold text-[#006FA6]`}
          >
            PHAQCHAS
          </h1>
          <h2
            className={`${poppins.className} text-gray-600 text-base sm:text-lg`}
          >
          ...
          <div className="text-left">
            <h1
              className={`${poppins.className} text-gray-700 text-sm sm:text-lg`}
            >
              Usuario
            </h1>
            <input
